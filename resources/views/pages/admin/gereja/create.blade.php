		...
		<div class="card-body">
			<form action="{{ route('admin.gereja.store') }}" method="POST" enctype="multipart/form-data">
				...
				<div class="mb-3">
					...
					<input type="date" name="tanggal_berdiri" class="form-control @error('tanggal_berdiri') is-invalid @enderror"
				...
				<div class="row">
					...
					<div class="col-md-4 mb-3">
						...
						<x-select-input id="kab_kota" label="Kabupaten/Kota" name="kab_kota" :options="['Surabaya']" placeholder="Pilih Kota"
							:selected="old('kab_kota')" />
						@error('kab_kota')
					...
					<div class="col-md-4 mb-3">
						...
						<x-select-input id="kecamatan" label="Kecamatan" name="kecamatan" :options="[]" placeholder="Pilih Kecamatan"
				...
				<div class="mb-3">
					...
					<input type="text" name="jarak_gereja_lain" class="form-control @error('jarak_gereja_lain') is-invalid @enderror"
				...
				<div class="mb-3">
					...
					<input type="text" name="nama_pendeta" class="form-control @error('nama_pendeta') is-invalid @enderror"
				...
				<div class="mb-3">
					...
					<x-select-input id="status_gereja" label="Status Gereja" name="status_gereja" :options="['permanen' => 'Permanen', 'semi-permanen' => 'Semi Permanen', 'tidak-permanen' => 'Tidak Permanen']"
				...
				<div class="row">
					...
					<div class="col-md-4 mb-3">
						...
						<div class="input-group mb-1">
							<input type="number" name="jumlah_umat[laki_laki]" class="form-control" placeholder="Jumlah laki-laki"
								value="{{ old('jumlah_umat.laki_laki', 0) }}" min="0">
							<span class="input-group-text d-flex align-items-center justify-content-center" style="width: 30%">
								Laki-laki
							</span>
						</div>
						...
						<div class="input-group">
							<input type="number" name="jumlah_umat[perempuan]" class="form-control" placeholder="Jumlah perempuan"
								value="{{ old('jumlah_umat.perempuan', 0) }}" min="0">
							<span class="input-group-text d-flex align-items-center justify-content-center" style="width: 30%">
								Perempuan
							</span>
						</div>
					...
					<div class="col-md-4 mb-3">
						...
						<div class="input-group mb-1">
							<input type="number" name="jumlah_majelis[laki_laki]" class="form-control" placeholder="Jumlah laki-laki"
								value="{{ old('jumlah_majelis.laki_laki', 0) }}" min="0">
							<span class="input-group-text d-flex align-items-center justify-content-center" style="width: 30%">
								Laki-laki
							</span>
						</div>
						...
						<div class="input-group">
							<input type="number" name="jumlah_majelis[perempuan]" class="form-control" placeholder="Jumlah perempuan"
								value="{{ old('jumlah_majelis.perempuan', 0) }}" min="0">
							<span class="input-group-text d-flex align-items-center justify-content-center" style="width: 30%">
								Perempuan
							</span>
						</div>
					...
					<div class="col-md-4 mb-3">
						...
						<div class="input-group mb-1">
							<input type="number" name="jumlah_pemuda[laki_laki]" class="form-control" placeholder="Jumlah laki-laki"
								value="{{ old('jumlah_pemuda.laki_laki', 0) }}" min="0">
							<span class="input-group-text d-flex align-items-center justify-content-center" style="width: 30%">
								Laki-laki
							</span>
						</div>
						...
						<div class="input-group">
							<input type="number" name="jumlah_pemuda[perempuan]" class="form-control" placeholder="Jumlah perempuan"
								value="{{ old('jumlah_pemuda.perempuan', 0) }}" min="0">
							<span class="input-group-text d-flex align-items-center justify-content-center" style="width: 30%">
								Perempuan
							</span>
						</div>
					...
					<div class="col-md-4 mb-3">
						...
						<div class="input-group mb-1">
							<input type="number" name="jumlah_guru_sekolah_minggu[laki_laki]" class="form-control"
								placeholder="Jumlah laki-laki" value="{{ old('jumlah_guru_sekolah_minggu.laki_laki', 0) }}" min="0">
							<span class="input-group-text d-flex align-items-center justify-content-center" style="width: 30%">
								Laki-laki
							</span>
						</div>
						...
						<div class="input-group">
							<input type="number" name="jumlah_guru_sekolah_minggu[perempuan]" class="form-control"
								placeholder="Jumlah perempuan" value="{{ old('jumlah_guru_sekolah_minggu.perempuan', 0) }}" min="0">
							<span class="input-group-text d-flex align-items-center justify-content-center" style="width: 30%">
								Perempuan
							</span>
						</div>
					...
					<div class="col-md-4 mb-3">
						...
						<div class="input-group mb-1">
							<input type="number" name="jumlah_murid_sekolah_minggu[laki_laki]" class="form-control"
								placeholder="Jumlah laki-laki" value="{{ old('jumlah_murid_sekolah_minggu.laki_laki', 0) }}" min="0">
							<span class="input-group-text d-flex align-items-center justify-content-center" style="width: 30%">
								Laki-laki
							</span>
						</div>
						...
						<div class="input-group">
							<input type="number" name="jumlah_murid_sekolah_minggu[perempuan]" class="form-control"
								placeholder="Jumlah perempuan" value="{{ old('jumlah_murid_sekolah_minggu.perempuan', 0) }}" min="0">
							<span class="input-group-text d-flex align-items-center justify-content-center" style="width: 30%">
								Perempuan
							</span>
						</div>

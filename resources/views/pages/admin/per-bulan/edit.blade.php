            ...
            <form action="{{ route('admin.per-bulan.update', $perBulan->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    @if($perBulan->daftar_gaji_path)
                        <a href="{{ asset('storage/' . $perBulan->daftar_gaji_path) }}" target="_blank"
                ...
                <div class="mb-3">
                    ...
                    @if($perBulan->daftar_hadir_path)
                        <a href="{{ asset('storage/' . $perBulan->daftar_hadir_path) }}" target="_blank"
                            class="text-primary text-decoration-underline">
                            Lihat File Lama
                        </a>
                    @else
                ...
                <div class="mb-3">
                    ...
                    @if($perBulan->rekening_bank_path)
                        <a href="{{ asset('storage/' . $perBulan->rekening_bank_path) }}" target="_blank"
                            class="text-primary text-decoration-underline">
                            Lihat File Lama
                        </a>
                    @else

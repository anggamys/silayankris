		...
		<div class="card-body">
			<form action="{{ route("admin.per-bulan.store") }}" method="POST" enctype="multipart/form-data">
				...
				<div class="mb-3">
					...
					<input type="file" name="daftar_gaji_path" id="daftar_gaji_path" class="form-control" required accept=".pdf">
				...
				<div class="mb-3">
					...
					<input type="file" name="daftar_hadir_path" id="daftar_hadir_path" class="form-control" required accept=".pdf">

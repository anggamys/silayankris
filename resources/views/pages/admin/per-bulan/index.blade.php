						...
						@forelse($perBulan as $item)
							<tr>
								...
								<td class="d-flex justify-content-center gap-2">
									<a href="{{ route("admin.per-bulan.show", $item) }}" class="btn btn-sm btn-info align-items-center text-light"
									...
									<form action="{{ route("admin.per-bulan.destroy", $item) }}" method="POST" class="d-inline"

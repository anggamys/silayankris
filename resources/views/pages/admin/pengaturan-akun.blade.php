...
@section('content')
    <div class="card shadow-sm border-0 mb-4 p-3">
        ...
        <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
            <h5 class="mb-0 fw-semibold fs-4">Pengaturan Akun</h5>
        </div>
            ...
            @if (request('tab', 'profile') == 'profile')
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 text-center mb-4">
                        ...
                        @php
                            ...
                            if (auth()->user()->profile_photo_path) {
                                $full = public_path('storage/' . auth()->user()->profile_photo_path);
                                if (file_exists($full)) {
                        ...
                        <form action="{{ route('admin.settings.update-photo') }}" method="POST"
                            ...
                            <div class="photo-upload-box">
                                ...
                                @if ($photoPath)
                                    <img id="photoPreview" src="{{ $photoPath }}" class="img-thumbnail rounded shadow-sm"
                                ...
                                @else
                                    <div id="photoPreview"
                                        ...
                                        style="width: 150px; height: 150px; background:#008080; color:white; font-size:48px; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px;">
                                        {{ $initials }}
                                    </div>
                                @endif
                                ...
                                <div class="d-inline-flex gap-2 mt-2"> <button type="button"
                    ...
                    <div class="col-md-9">
                        ...
                        @if ($guru)
                            <hr class="my-4">
                            <h5 class="fw-bold mb-3">Informasi Guru</h5>
                        ...
                        {{-- INFORMASI STAFF GEREJA --}}
                        @php
                            $staff = auth()->user()->role === 'staff-gereja' ? auth()->user()->staffGereja : null;
                        @endphp

                        @if ($staff && $staff->gereja)
                            <hr class="my-4">
                            <div class="form-section-title">Informasi Gereja</div>
